...
|---|---|---|---|
| reading (prefill) | **271–330 tok/s by depth (salted)** | ingesting your prompt | **CORRECTED 2026-09-18** — the prior ~260–390 band mixed regimes incl. unsalted back-to-back prompts (inflation class, our "148–163 artifact"). Salted single-regime on the adopted stack (v0.4.1-HIP, mtp3+ngram-mod): 8K **318–330** / 16K **300–312** / 32K **271–280**; upper endpoints vision-attached, lower endpoints same-night vision-off arms with the vision delta receipted ≈0.3% (clean A/B: 317.9 vs 318.7) — n=1 per rung, ranges span clean same-night measurements. Receipts: window7/vision-restored-verify.json (330.0/311.5/280.4, vision:true), window7 ladders (299.5, 271.2), clean-probe set (317.9). Live-traffic class (08-21: 262/305) kept as a separate regime — cross-regime comparison is meaningless by our four-regime law. If you cited the old band, please re-cite this one. |
